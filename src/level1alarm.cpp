...
Level1Alarm::Level1Alarm(QWidget *parent) : QFrame(parent), ui(new Ui::Level1Alarm) {
    ...
    QString style1 =QString("QPushButton{background-image:url(:/Blank1/Frame 10106.png);border: none;background-repeat: no-repeat;"
    ...
    ui->Level1_label->setStyleSheet("QLabel{background-image:url(:/Blank1/Group 10570.png);border: none;background-repeat: no-repeat;"
               "background-position: center;background-color: transparent;}");
}
